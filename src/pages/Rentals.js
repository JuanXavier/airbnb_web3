					...
					{rentalsList &&
						rentalsList.map((e, i) => {
							return (
								<>
									<hr className='line2' />
									<div className={highLight == i ? 'rentalDiv' : 'rentalDiv'}>
										<img className='rentalImg' src={e.attributes.imgUrl} alt='rental'></img>
										<div className='rentalInfo'>
											...
											<div className='bottomButton'>
												...
												<div className='price'>
													<Icon fill='#808080' size={10} svg='matic' /> {e.attributes.pricePerDay} /
													Day
												</div>
											</div>
										</div>
